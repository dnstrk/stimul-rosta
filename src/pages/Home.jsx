                        ...
                        <div className="banner__info">
                            ...
                            <form className="banner__form">
                                ...
                                <div className="banner__specRadioGroup">
                                    <RadioSpec
                                        radio={1}
                                        specialisation="Кассир"
                                    />
                                    <RadioSpec
                                        radio={2}
                                        specialisation="Официант"
                                    />
                                    <RadioSpec
                                        radio={3}
                                        specialisation="Промоутер"
                                    />
                                    <RadioSpec
                                        radio={4}
                                        specialisation="Упаковщик"
                                    />
                                    <RadioSpec
                                        radio={5}
                                        specialisation="Продавец"
                                    />
                                    <RadioSpec
                                        radio={6}
                                    ...
                                    <RadioSpec
                                        radio={7}
                                        specialisation="Сотрудник клининга"
                                    />
                                    <RadioSpec
                                        radio={8}
                                        specialisation="Горничная"
                                    />
                                    <RadioSpec
                                        radio={9}
                                        specialisation="Фасовщик"
                                    />
                                    <RadioSpec
                                        radio={10}
                                        specialisation="Мойщик"
                                    />
                                    <Link
                                        to="/specialties"
