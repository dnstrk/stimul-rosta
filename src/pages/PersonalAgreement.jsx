                ...
                <div className="persAgr__wrap">
                    ...
                    <div className="persAgr__wrap__text">
                        <p className="par">
                            ...
                            ограниченной ответственностью «Стимул Роста» (далее –
                            Оператор, ООО "Стимул Роста"), расположенного на
                            доменном имени https://stimulrosta.ru/.
                        </p>
                        <p className="par">
                        ...
                        <p className="sub">
                            ...
                            Интернет под доменным именем https://stimulrosta.ru/.
                        </p>
                        <p className="par">
